...
class PlayButton : public BWidgets::ToggleButton
{
public:
	PlayButton () : PlayButton (0.0, 0.0, BWIDGETS_DEFAULT_BUTTON_WIDTH, BWIDGETS_DEFAULT_BUTTON_HEIGHT, "button", 0.0) {}

	PlayButton (const double x, const double y, const double width, const double height, const std::string& name, double defaultValue = 0.0) :
			ToggleButton (x, y, width, height, name, defaultValue) {}

	virtual Widget* clone () const override {return new PlayButton (*this);}
